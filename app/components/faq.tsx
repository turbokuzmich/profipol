  ...
  const faqItems = [
    {
      ...
      answer:
        "Все зависит от общей площади и толщины стяжки, а также от высоты этажа на который нужно будет доставить оборудование. Для расчета стоимости в вашем случае нужно оставить заявку через форму связи и дождаться звонка менеджера. Минимальный заказ — 75 000 ₽.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Мы предоставляем гарантию 3 года на все выполненные работы. В случае возникновения проблем, связанных с качеством выполненных работ, мы устраним их бесплатно.",
    },
    {
